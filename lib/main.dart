...
class _MyAppState extends State<MyApp> {
  ...
  late Stream<QonvayPaymentDevFirebaseUser> userStream;
  QonvayPaymentDevFirebaseUser? initialUser;
  ...
  void initState() {
    super.initState();
    userStream = qonvayPaymentDevFirebaseUserStream()
